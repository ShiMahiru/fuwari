...
background: {
	...
	favicon: [
		// Leave this array empty to use the default favicon
		 {
		   src: 'https://q2.qlogo.cn/headimg_dl?dst_uin=242531778&spec=0',    // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	...
	links: [
      ...
      name: 'QQ',
      icon: 'fa6-brands:qq',
      url: 'https://qm.qq.com/q/jbMBofFJ4c',
        },
		{
			name: "Email",
